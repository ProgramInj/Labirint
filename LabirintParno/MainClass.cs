    ...
    class MainClass
    {
        ...
        public void RunnerGenerator(string flank)
        {
            while (flank.Length > 0)
            {
                ...
                var reversedVector = new Point(-playerVector.dl, -playerVector.shir);
                CLoseSideByDirection(lab.arr[currentCoord.shir, currentCoord.dl], reversedVector, newValue: true);
